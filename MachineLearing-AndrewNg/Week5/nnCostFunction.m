...
% Initialize value of the cost function
J = 0;

for i = 1 : m
  % Feedforward
  a1 = reshape(X(i, :), input_layer_size, 1);
  a1 = [1; a1];
  a2 = sigmoid(Theta1 * a1);
  a2 = [1; a2];
  a3 = sigmoid(Theta2 * a2);

  % Create the actually output vector
  yOutput = zeros(num_labels, 1);
  yOutput(y(i)) = 1;
 
  % Add value to the cost function
  J += - yOutput' * log(a3) - (1 .- yOutput)' * log(1 .- a3);
